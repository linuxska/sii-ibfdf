...
"<br/>"."<br/>"."Total de Matrimonios: "."N"."<br/>"."Total de niños: "."peques"."<br/>"."Total de Jovenes: "."N"."<br/>"."Total de Señoritas: "."N".
"<br/>"."Total de personas a hospedar: "."N"."<br/>";
...
public function executeListImprimirCoordenadas()
  {
  ...
  //$direccioncompleta=$this->Casa->getFullDireccion();
  $direccioncompleta=$this->Casa->getCoordenadas();
  $ruta=$this->Casa->getRuta();
  $config = sfTCPDFPluginConfigHandler::loadConfig();
...
//var_dump($direccioncompleta); die();
 $html3 = '<font size="10" color="#0000FF">Informacion de horarios:'.'<br/>'.'
  ...
  $html = "<br/>"."<strong>Bienvenidos</strong> a la Conferencia de la Espada y Fuegos de Evangelismo"."<br/>"."<br/>"."Le recibe hno(a): "
.$nombre."<br/>"."En calle: ".$calle."            Ruta: ".$ruta."<br/>"."Colonia: ".$colonia."<br/>"." Municipio de: <cite>".$ciudad
." Guanajuato ".$id."</cite><br/>"."<br/>".'<img style="-webkit-user-select: none; cursor: -webkit-zoom-out; " align="middle" height="1000" width="1000"src="http://maps.googleapis.com/maps/api/staticmap?&markers=size:mid%7Ccolor:red%7C'
.$direccioncompleta.'&size=1000x1000&sensor=false"/>'.'<br/>'.$html3;
  // Print text using writeHTMLCell()
  $pdf->writeHTMLCell($w=0, $h=0, $x='', $y='', $html, $border=0, $ln=1, $fill=0, $reseth=true, $align='', $autopadding=true);
